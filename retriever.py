...
train_dataloader = DataLoader(ds_trn, batch_size=batch_size)
val_dataloader = DataLoader(ds_val, batch_size=batch_size)
inf_datalodaer = DataLoader(ds_val, batch_size=len(ds_val))
...
for epoch in trange(1, 1001):
    ...
    for batch in tqdm(val_dataloader):
        ...
        print(f"epoch: {epoch}, R@1: {recall_top1:.3f}, R@5: {recall_top5:.3f}, R@10: {recall_top10:.3f}")
...
>>>>>>> 73b6fac5dfcc9352ea493f9cf1574714f0175af8
